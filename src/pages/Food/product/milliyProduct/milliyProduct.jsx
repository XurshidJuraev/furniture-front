...
const MilliyProduct = () => {
    ...
    const fetchData = (Restaruant) => {
      ...
      fetch('https://furniture-back.herokuapp.com/milOrder', {
        method: 'POST',
    ...
    const renderProduct = () => (
      <>
        <div className='allRest'>
          {users.length > 0 &&
          users.map((Restaruant, index) => (
            <div className="rest" key={index}>
              <div>
